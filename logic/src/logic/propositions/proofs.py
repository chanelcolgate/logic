...
class InferenceRule:
    ...
    def __repr__(self) -> str:
        ...
        """
        return (
            str([str(assumptions) for assumptions in self.assumptions])
            + " ==> "
            + "'"
            + str(self.conclusion)
            + "'"
    ...
    def specialize(
        ...
        """Specializes the current inference rule by simulateneously substituing
        ...
        specialized_conclusion = Formula.substitute_variables(
            self.conclusion, specialization_map
        )
...
class Proof:
    ...
    rules: FronzenSet[InferenceRule]
    ...
    class Line:
        ...
        is justified either as an assumptions of the proof, or as the conclusion
        ...
        def __init__(
            ...
            Parameters:
                ...
                assumptions: numbers of previous lines in the proof whose
                    ...
                    `None` if the formula is to be justified as an assumptions
                    of the proof.
            """
        ...
        def is_assumption(self) -> bool:
            """Checks if the current proof line is justified as an assumptions of
            the proof.
    ...
    def is_line_valid(self, line_number: int) -> bool:
        ...
        Returns:
            If the specified line is justified as an assumptions, then `True`
...
def prove_specialization(proof: Proof, specialization: InferenceRule) -> Proof:
    ...
    speciallization of that inference rule.

    Parameters:
        proof: valid proof to convert.
        specializtion: specialization of the rule proven by the given proof.
